"""change document_url to text

Revision ID: 3db71e0ffa12
Revises: 096fa2e4712e
Create Date: 2026-06-16 21:25:59.322806
...
revision: str = '3db71e0ffa12'
down_revision: Union[str, Sequence[str], None] = '096fa2e4712e'
...
def upgrade() -> None:
    ...
    op.alter_column('documents', 'document_url',
