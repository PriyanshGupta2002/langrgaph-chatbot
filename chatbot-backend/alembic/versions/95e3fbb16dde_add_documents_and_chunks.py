...
Revision ID: 95e3fbb16dde
Revises: 5726cf529909
Create Date: 2026-06-16 17:42:00.374303
...
revision: str = "95e3fbb16dde"
down_revision: Union[str, Sequence[str], None] = "5726cf529909"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "document_stage",
            sa.Enum("PROCESSING", "COMPLETED", name="documentstatus"),
            nullable=True,
        ),
